...
PyObject * QuantityPy::staticCallback_getFormat (PyObject *self, void * /*closure*/)
{
    ...
    try {
        ...
        PyErr_SetString(Base::BaseExceptionFreeCADError, "Unknown exception while reading attribute 'Format' of object 'Quantity'");
        return NULL;
    }
}
...
int QuantityPy::staticCallback_setFormat (PyObject *self, PyObject *value, void * /*closure*/)
{
    ...
    try {
        ...
        PyErr_SetString(Base::BaseExceptionFreeCADError, "Unknown exception while writing attribute 'Format' of object 'Quantity'");
        return -1;
    }
}
