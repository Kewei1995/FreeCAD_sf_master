...
PyObject * SurfaceOfExtrusionPy::staticCallback_uIso (PyObject *self, PyObject *args)
{
    ...
    if (!self) {
        PyErr_SetString(PyExc_TypeError, "descriptor 'uIso' of 'Part.GeomSurfaceOfExtrusion' object needs an argument");
        return NULL;
    }
...
PyObject * SurfaceOfExtrusionPy::staticCallback_vIso (PyObject *self, PyObject *args)
{
    // make sure that not a null pointer is passed
    if (!self) {
        PyErr_SetString(PyExc_TypeError, "descriptor 'vIso' of 'Part.GeomSurfaceOfExtrusion' object needs an argument");
        return NULL;
    }
